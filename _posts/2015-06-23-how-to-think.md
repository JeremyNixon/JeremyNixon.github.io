...
2. Decisive
    ...
    5. Search for Objective Data to Inform Decisions

    6. Small Experiment / Ooch

    7. What are the options that we’re not considering?

    8. What beliefs do I have that I should question?

    9. What is the evidence that contradicts my beliefs?

    10. What are the underlying desires guiding my decision?

    11. Assume that some or all options are eliminated or required. What do we do?

    12. What is the opportunity cost of this decision? (Opportunity Cost)

    13. Can we reframe between prevention focus and promotion focus?

    14. Who else had this problem, and how can we learn from them? (History)

    15. What evidence, if witnessed, would change your mind?

    16. When this went well, what was happening?

    17. What was the close-up experience of people who made my decision in the past? (Inside View)

    18. How will I feel about this decision in 5 minutes, in 4 months, in 3 years?

    19. Premortem - imagine this decision going horribly wrong and going extremely well. What caused it?

    20. What is the courageous action? The imaginative action?

    21. What would other people of different types do in my position? (Different person heuristic)

3. Getting to Yes

    22. Escape Ego Association (Positional Negotiation)

    23. Separate the people from the problem

    24. Escape to underlying interests, of which the positions are made

    25. Invent Options for Mutual Gain

    26. Use Objective Criteria

4. CFAR Manual

    27. Visualization over possible futures (similar to best state worst state)

    28. Actually Try - OMG I need to do this all the time, it’s huge

    29. Murphyjitsu

    30. Identify motivating urges

    31. Identify aversive factors

    32. Combine objective information with Value of Information

    33. Inferential Distance (what knowledge is requisite)

    34. Explain the problem in detail (to a duck) 

    35. Actually understand the problem

    36. Intensity

    37. Identify Bottleneck to problem solving

    38. Obvious next step that needs to happen

    39. Where did the problem go wrong? Did it happen earlier than expected?

    40. Steel-Man each idea

    41. Mindset check - are you looking for evidence for a particular option, or genuinely a scout

    42. Physiology check - what’s your psychological state?

    43. City of Lights - separate yourself into different parts with different opinions

    44. How can training occur naturally in behavior (deliberate performance)?

    45. Overlearning - seeing an idea everywhere, immersion

    46. Postmortem - when this has failed in the past, what happened?

    47. Exposure Therapy

    48. Fragment - break the problem into smaller pieces/chunks

    49. Identity - Sociology

5. Poor Charlie’s Almanac

    50. Specialization/Comparative Advantage

    51. Law of Large Numbers / Poker-style optimal play, long term tends to theoretical values

    52. Invert! Invert the question or the situation, try reversing everything.

    53. Mean Regression

    54. Backup System - All critical systems have a backup, avoid downside exposure

    55. Simplicity. Make as few decisions as possible, have few dependencies.

    56. Equilibrium

    57. Critical Mass

    58. Think at the Margin
    ...
    63. Risk/Loss/Uncertainty Aversion
    ...
    67. Tight/Aggressive approach to decisions

    68. Pareto Principle (80/20 rule)

    69. Man with a hammer syndrome

    70. Tragedy of the Commons

    71. No-Brainer / Do the obvious thing